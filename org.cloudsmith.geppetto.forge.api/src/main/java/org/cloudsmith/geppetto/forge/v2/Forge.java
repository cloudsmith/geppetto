...
public class Forge {
	...
	/**
	 * Create a new instance based on given preferences.
	 * 
	 * @param forgePreferences
	 *            The preferences that this instance will use
	 */
	...
	/**
	 * Creates a service that can be used when interacting with the Forge as
