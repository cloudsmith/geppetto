...
/**
 * <!-- begin-user-doc --> A sample utility for the '<em><b>forge</b></em>'
...
public class ForgeExample {
	...
	public static void main(String[] args) {
		...
		//
		resourceSet.getPackageRegistry().put(ForgePackage.eNS_URI, ForgePackage.eINSTANCE);
		...
		if(args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.forge"));
				Forge root = ForgeFactory.eINSTANCE.createForge();
