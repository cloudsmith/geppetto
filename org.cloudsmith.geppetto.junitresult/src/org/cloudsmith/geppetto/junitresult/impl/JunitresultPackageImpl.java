...
public class JunitresultPackageImpl extends EPackageImpl implements JunitresultPackage {
	...
	public void createPackageContents() {
		...
		createEReference(testcaseEClass, TESTCASE__ERROR);
		createEReference(testcaseEClass, TESTCASE__FAILURE);
	 ...
	 * @generated
	 */
	public EReference getTestcase_Error() {
	 ...
	 * @generated
	 */
	public EReference getTestcase_Failure() {
	...
	public void initializePackageContents() {
		...
		initEReference(
			...
			!IS_DERIVED, IS_ORDERED);
		initEAttribute(
			getTestsuite_System_out(), ecorePackage.getEString(), "system_out", null, 1, 1, Testsuite.class,
			!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(
			getTestsuite_System_err(), ecorePackage.getEString(), "system_err", null, 1, 1, Testsuite.class,
			!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(
			getTestsuite_Hostname(), ecorePackage.getEString(), "hostname", null, 1, 1, Testsuite.class, !IS_TRANSIENT,
			!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(
			getTestsuite_Timestamp(), ecorePackage.getEDate(), "timestamp", null, 1, 1, Testsuite.class, !IS_TRANSIENT,
			!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(
			getTestsuite_Time(), ecorePackage.getEString(), "time", null, 1, 1, Testsuite.class, !IS_TRANSIENT,
			!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(
		...
		initEReference(
			getTestcase_Error(), this.getError(), null, "error", null, 0, 1, Testcase.class, !IS_TRANSIENT,
			!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
			IS_ORDERED);
		initEReference(
			getTestcase_Failure(), this.getFailure(), null, "failure", null, 0, 1, Testcase.class, !IS_TRANSIENT,
			!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
			IS_ORDERED);
		initEAttribute(
			getTestcase_Classname(), ecorePackage.getEString(), "classname", null, 1, 1, Testcase.class, !IS_TRANSIENT,
			!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(
			getTestcase_Name(), ecorePackage.getEString(), "name", null, 1, 1, Testcase.class, !IS_TRANSIENT,
			!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(
			getTestcase_Time(), ecorePackage.getEString(), "time", null, 1, 1, Testcase.class, !IS_TRANSIENT,
			!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(
			...
			IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(
			getNegativeResult_Message(), ecorePackage.getEString(), "message", null, 1, 1, NegativeResult.class,
			!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(
			getNegativeResult_Type(), ecorePackage.getEString(), "type", null, 1, 1, NegativeResult.class,
			!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(
		...
		initEAttribute(
			...
			IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(
			getAbstractAggregatedTest_Failures(), ecorePackage.getEInt(), "failures", null, 1, 1,
			AbstractAggregatedTest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
			IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(
			getAbstractAggregatedTest_Errors(), ecorePackage.getEInt(), "errors", null, 1, 1,
			AbstractAggregatedTest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
			IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
