	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case JunitresultPackage.TESTSUITE: {
				...
				if (result == null) result = caseAbstractAggregatedTest(testsuite);
				if (result == null) result = caseJunitResult(testsuite);
			...
			case JunitresultPackage.ERROR: {
				...
				if (result == null) result = caseNegativeResult(error);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JunitresultPackage.FAILURE: {
				...
				if (result == null) result = caseNegativeResult(failure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case JunitresultPackage.TESTRUN: {
				...
				if (result == null) result = caseAbstractAggregatedTest(testrun);
				if (result == null) result = caseJunitResult(testrun);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JunitresultPackage.ABSTRACT_AGGREGATED_TEST: {
				...
				if (result == null) result = caseJunitResult(abstractAggregatedTest);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JunitresultPackage.TESTSUITES: {
				...
				if (result == null) result = caseJunitResult(testsuites);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case JunitresultPackage.SKIPPED: {
				...
				if (result == null) result = caseNegativeResult(skipped);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
