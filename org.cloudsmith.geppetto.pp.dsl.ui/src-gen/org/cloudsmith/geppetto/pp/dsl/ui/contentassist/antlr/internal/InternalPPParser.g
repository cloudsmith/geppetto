...
ruleTextExpression 
    ...
    :
(
{ before(grammarAccess.getTextExpressionAccess().getVariableTextExpressionParserRuleCall()); }
	ruleVariableTextExpression
{ after(grammarAccess.getTextExpressionAccess().getVariableTextExpressionParserRuleCall()); }
)
