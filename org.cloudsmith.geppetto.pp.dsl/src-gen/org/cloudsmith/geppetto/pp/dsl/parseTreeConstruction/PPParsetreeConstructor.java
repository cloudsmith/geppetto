...
protected class ThisRootNode extends RootToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			...
			case 6: return new AttributeDefinition_Group(this, this, 6, inst);
			case 7: return new AttributeAddition_Group(this, this, 7, inst);
			case 8: return new AttributeOperation_Alternatives(this, this, 8, inst);
			case 9: return new AttributeOperations_Group(this, this, 9, inst);
			case 10: return new AssignmentExpression_Group(this, this, 10, inst);
			case 11: return new AppendExpression_Group(this, this, 11, inst);
			case 12: return new OrExpression_Group(this, this, 12, inst);
			case 13: return new AndExpression_Group(this, this, 13, inst);
			case 14: return new RelationalExpression_Group(this, this, 14, inst);
			case 15: return new EqualityExpression_Group(this, this, 15, inst);
			case 16: return new ShiftExpression_Group(this, this, 16, inst);
			...
			case 19: return new MatchingExpression_Group(this, this, 19, inst);
			case 20: return new InExpression_Group(this, this, 20, inst);
			case 21: return new UnaryOrHigherExpression_Alternatives(this, this, 21, inst);
			case 22: return new UnaryMinusExpression_Group(this, this, 22, inst);
			case 23: return new NotExpression_Group(this, this, 23, inst);
			case 24: return new InfixExpression_Group(this, this, 24, inst);
			case 25: return new CollectExpression_Group(this, this, 25, inst);
			case 26: return new CollectQuery_Alternatives(this, this, 26, inst);
			case 27: return new VirtualCollectQuery_Group(this, this, 27, inst);
			case 28: return new ExportedCollectQuery_Group(this, this, 28, inst);
			case 29: return new SelectorExpression_Group(this, this, 29, inst);
			case 30: return new SelectorEntry_Group(this, this, 30, inst);
			...
			case 33: return new NodeDefinition_Group(this, this, 33, inst);
			case 34: return new HostReference_Alternatives(this, this, 34, inst);
...
protected class Expression_RelationshipExpressionParserRuleCall extends RuleCallToken {
	...
	public IEObjectConsumer tryConsume() {
		if(getEObject().eClass() != grammarAccess.getAdditiveExpressionAccess().getAdditiveExpressionLeftExprAction_1_0().getType().getClassifier() && 
		   ...
		   getEObject().eClass() != grammarAccess.getInfixExpressionAccess().getAtExpressionLeftExprAction_1_0().getType().getClassifier() && 
		   ...
		   getEObject().eClass() != grammarAccess.getParenthisedExpressionRule().getType().getClassifier() && 
...
protected class AttributeDefinition_Group extends GroupToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new AttributeDefinition_ValueAssignment_2(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
protected class AttributeDefinition_KeyAssignment_0 extends AssignmentToken  {
	
	public AttributeDefinition_KeyAssignment_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getAttributeDefinitionAccess().getKeyAssignment_0();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(valueSerializer.isValid(obj.getEObject(), grammarAccess.getAttributeDefinitionAccess().getKeyUnionNameOrReferenceParserRuleCall_0_0(), value, null)) {
			type = AssignmentType.DATATYPE_RULE_CALL;
			element = grammarAccess.getAttributeDefinitionAccess().getKeyUnionNameOrReferenceParserRuleCall_0_0();
			return obj;
		}
		return null;
	}
...
// "=>"
protected class AttributeDefinition_EqualsSignGreaterThanSignKeyword_1 extends KeywordToken  {
	
	public AttributeDefinition_EqualsSignGreaterThanSignKeyword_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getAttributeDefinitionAccess().getEqualsSignGreaterThanSignKeyword_1();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new AttributeDefinition_KeyAssignment_0(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// value=Expression
protected class AttributeDefinition_ValueAssignment_2 extends AssignmentToken  {
	
	public AttributeDefinition_ValueAssignment_2(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getAttributeDefinitionAccess().getValueAssignment_2();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getExpressionRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getAttributeDefinitionAccess().getValueExpressionParserRuleCall_2_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new AttributeDefinition_EqualsSignGreaterThanSignKeyword_1(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
// key=unionNameOrReference "+>" value=Expression
protected class AttributeAddition_Group extends GroupToken {
	
	public AttributeAddition_Group(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Group getGrammarElement() {
		return grammarAccess.getAttributeAdditionAccess().getGroup();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new AttributeAddition_ValueAssignment_2(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
    ...
    @Override
	public IEObjectConsumer tryConsume() {
		if(getEObject().eClass() != grammarAccess.getAttributeAdditionRule().getType().getClassifier())
			return null;
		return eObjectConsumer;
	}
...
// key=unionNameOrReference
protected class AttributeAddition_KeyAssignment_0 extends AssignmentToken  {
	
	public AttributeAddition_KeyAssignment_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getAttributeAdditionAccess().getKeyAssignment_0();
	}
	...
	public IEObjectConsumer tryConsume() {
		if((value = eObjectConsumer.getConsumable("key",true)) == null) return null;
		IEObjectConsumer obj = eObjectConsumer.cloneAndConsume("key");
		if(valueSerializer.isValid(obj.getEObject(), grammarAccess.getAttributeAdditionAccess().getKeyUnionNameOrReferenceParserRuleCall_0_0(), value, null)) {
			type = AssignmentType.DATATYPE_RULE_CALL;
			element = grammarAccess.getAttributeAdditionAccess().getKeyUnionNameOrReferenceParserRuleCall_0_0();
			return obj;
		}
		return null;
	}
...
// "+>"
protected class AttributeAddition_PlusSignGreaterThanSignKeyword_1 extends KeywordToken  {
	
	public AttributeAddition_PlusSignGreaterThanSignKeyword_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getAttributeAdditionAccess().getPlusSignGreaterThanSignKeyword_1();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new AttributeAddition_KeyAssignment_0(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// value=Expression
protected class AttributeAddition_ValueAssignment_2 extends AssignmentToken  {
	
	public AttributeAddition_ValueAssignment_2(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getAttributeAdditionAccess().getValueAssignment_2();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getExpressionRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getAttributeAdditionAccess().getValueExpressionParserRuleCall_2_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new AttributeAddition_PlusSignGreaterThanSignKeyword_1(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
// AttributeDefinition | AttributeAddition
protected class AttributeOperation_Alternatives extends AlternativesToken {

	public AttributeOperation_Alternatives(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Alternatives getGrammarElement() {
		return grammarAccess.getAttributeOperationAccess().getAlternatives();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new AttributeOperation_AttributeDefinitionParserRuleCall_0(lastRuleCallOrigin, this, 0, inst);
			case 1: return new AttributeOperation_AttributeAdditionParserRuleCall_1(lastRuleCallOrigin, this, 1, inst);
			default: return null;
		}	
	}
...
// AttributeDefinition
protected class AttributeOperation_AttributeDefinitionParserRuleCall_0 extends RuleCallToken {
	
	public AttributeOperation_AttributeDefinitionParserRuleCall_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public RuleCall getGrammarElement() {
		return grammarAccess.getAttributeOperationAccess().getAttributeDefinitionParserRuleCall_0();
	}
...
// AttributeAddition
protected class AttributeOperation_AttributeAdditionParserRuleCall_1 extends RuleCallToken {
	
	public AttributeOperation_AttributeAdditionParserRuleCall_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public RuleCall getGrammarElement() {
		return grammarAccess.getAttributeOperationAccess().getAttributeAdditionParserRuleCall_1();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new AttributeAddition_Group(this, this, 0, inst);
			default: return null;
		}	
	}
	...
	public IEObjectConsumer tryConsume() {
		if(getEObject().eClass() != grammarAccess.getAttributeAdditionRule().getType().getClassifier())
			return null;
		if(checkForRecursion(AttributeAddition_Group.class, eObjectConsumer)) return null;
		return eObjectConsumer;
	}
...
protected class AttributeOperations_Group extends GroupToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new AttributeOperations_Group_1(lastRuleCallOrigin, this, 0, inst);
...
protected class AttributeOperations_AttributesAssignment_0 extends AssignmentToken  {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new AttributeOperation_Alternatives(this, this, 0, inst);
			default: return null;
		}	
	}
...
// ("," attributes+=AttributeOperation)*
protected class AttributeOperations_Group_1 extends GroupToken {
	
	public AttributeOperations_Group_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Group getGrammarElement() {
		return grammarAccess.getAttributeOperationsAccess().getGroup_1();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new AttributeOperations_AttributesAssignment_1_1(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// ","
protected class AttributeOperations_CommaKeyword_1_0 extends KeywordToken  {
	
	public AttributeOperations_CommaKeyword_1_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getAttributeOperationsAccess().getCommaKeyword_1_0();
	}
...
protected class AttributeOperations_AttributesAssignment_1_1 extends AssignmentToken  {
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new AttributeOperations_CommaKeyword_1_0(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
protected class AdditiveExpression_MultiplicativeExpressionParserRuleCall_0 extends RuleCallToken {
    ...
    @Override
	public IEObjectConsumer tryConsume() {
		if(getEObject().eClass() != grammarAccess.getInfixExpressionAccess().getAtExpressionLeftExprAction_1_0().getType().getClassifier() && 
		   getEObject().eClass() != grammarAccess.getCaseExpressionRule().getType().getClassifier() && 
		   getEObject().eClass() != grammarAccess.getCollectExpressionAccess().getCollectExpressionClassReferenceAction_1_0().getType().getClassifier() && 
		   getEObject().eClass() != grammarAccess.getDefinitionRule().getType().getClassifier() && 
		   getEObject().eClass() != grammarAccess.getDoubleQuotedStringRule().getType().getClassifier() && 
...
protected class UnaryOrHigherExpression_Alternatives extends AlternativesToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			...
			case 2: return new UnaryOrHigherExpression_InfixExpressionParserRuleCall_2(lastRuleCallOrigin, this, 2, inst);
			default: return null;
		}	
	}
...
// InfixExpression
protected class UnaryOrHigherExpression_InfixExpressionParserRuleCall_2 extends RuleCallToken {
	
	public UnaryOrHigherExpression_InfixExpressionParserRuleCall_2(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public RuleCall getGrammarElement() {
		return grammarAccess.getUnaryOrHigherExpressionAccess().getInfixExpressionParserRuleCall_2();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getInfixExpressionRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getUnaryMinusExpressionAccess().getExprInfixExpressionParserRuleCall_1_0(); 
				consumed = obj;
				return param;
			}
		}
...
protected class NotExpression_ExprAssignment_1 extends AssignmentToken  {
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getInfixExpressionRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getNotExpressionAccess().getExprInfixExpressionParserRuleCall_1_0(); 
				consumed = obj;
				return param;
			}
		}
...
protected class InfixExpression_Group extends GroupToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new InfixExpression_Group_1(lastRuleCallOrigin, this, 0, inst);
			case 1: return new InfixExpression_CollectExpressionParserRuleCall_0(lastRuleCallOrigin, this, 1, inst);
			default: return null;
		}	
	}
...
// CollectExpression
protected class InfixExpression_CollectExpressionParserRuleCall_0 extends RuleCallToken {
	
	public InfixExpression_CollectExpressionParserRuleCall_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public RuleCall getGrammarElement() {
		return grammarAccess.getInfixExpressionAccess().getCollectExpressionParserRuleCall_0();
	}
...
protected class InfixExpression_Group_1 extends GroupToken {
	...
	public InfixExpression_Group_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new InfixExpression_RightSquareBracketKeyword_1_3(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
protected class InfixExpression_AtExpressionLeftExprAction_1_0 extends ActionToken  {

	public InfixExpression_AtExpressionLeftExprAction_1_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Action getGrammarElement() {
		return grammarAccess.getInfixExpressionAccess().getAtExpressionLeftExprAction_1_0();
	}
...
// "["
protected class InfixExpression_LeftSquareBracketKeyword_1_1 extends KeywordToken  {
	
	public InfixExpression_LeftSquareBracketKeyword_1_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getInfixExpressionAccess().getLeftSquareBracketKeyword_1_1();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new InfixExpression_AtExpressionLeftExprAction_1_0(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
protected class InfixExpression_Group_1_2 extends GroupToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new InfixExpression_Group_1_2_1(lastRuleCallOrigin, this, 0, inst);
			case 1: return new InfixExpression_ParametersAssignment_1_2_0(lastRuleCallOrigin, this, 1, inst);
			default: return null;
		}	
	}
...
protected class InfixExpression_ParametersAssignment_1_2_0 extends AssignmentToken  {
	
	public InfixExpression_ParametersAssignment_1_2_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getInfixExpressionAccess().getParametersAssignment_1_2_0();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getExpressionRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getInfixExpressionAccess().getParametersExpressionParserRuleCall_1_2_0_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new InfixExpression_LeftSquareBracketKeyword_1_1(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
// ("," parameters+=Expression)*
protected class InfixExpression_Group_1_2_1 extends GroupToken {
	
	public InfixExpression_Group_1_2_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Group getGrammarElement() {
		return grammarAccess.getInfixExpressionAccess().getGroup_1_2_1();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new InfixExpression_ParametersAssignment_1_2_1_1(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// ","
protected class InfixExpression_CommaKeyword_1_2_1_0 extends KeywordToken  {
	
	public InfixExpression_CommaKeyword_1_2_1_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getInfixExpressionAccess().getCommaKeyword_1_2_1_0();
	}
...
// parameters+=Expression
protected class InfixExpression_ParametersAssignment_1_2_1_1 extends AssignmentToken  {
	
	public InfixExpression_ParametersAssignment_1_2_1_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getInfixExpressionAccess().getParametersAssignment_1_2_1_1();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getExpressionRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getInfixExpressionAccess().getParametersExpressionParserRuleCall_1_2_1_1_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new InfixExpression_CommaKeyword_1_2_1_0(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
// "]"
protected class InfixExpression_RightSquareBracketKeyword_1_3 extends KeywordToken  {
	
	public InfixExpression_RightSquareBracketKeyword_1_3(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getInfixExpressionAccess().getRightSquareBracketKeyword_1_3();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new InfixExpression_Group_1_2(lastRuleCallOrigin, this, 0, inst);
			case 1: return new InfixExpression_LeftSquareBracketKeyword_1_1(lastRuleCallOrigin, this, 1, inst);
			default: return null;
		}	
	}
...
protected class SelectorExpression_Group extends GroupToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			...
			case 1: return new SelectorExpression_FunctionCallParserRuleCall_0(lastRuleCallOrigin, this, 1, inst);
			default: return null;
		}	
	}
...
// FunctionCall
protected class SelectorExpression_FunctionCallParserRuleCall_0 extends RuleCallToken {
	
	public SelectorExpression_FunctionCallParserRuleCall_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public RuleCall getGrammarElement() {
		return grammarAccess.getSelectorExpressionAccess().getFunctionCallParserRuleCall_0();
	}
...
protected class SelectorExpression_SelectorExpressionLeftExprAction_1_0 extends ActionToken  {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new SelectorExpression_FunctionCallParserRuleCall_0(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
protected class PrimaryExpression_ParenthisedExpressionParserRuleCall_9 extends RuleCallToken {
    ...
    @Override
	public IEObjectConsumer tryConsume() {
		if(getEObject().eClass() != grammarAccess.getParenthisedExpressionRule().getType().getClassifier())
			return null;
...
// "="
protected class DefinitionArgument_EqualsSignKeyword_1_0 extends KeywordToken  {
	
	public DefinitionArgument_EqualsSignKeyword_1_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getDefinitionArgumentAccess().getEqualsSignKeyword_1_0();
	}
...
protected class DefinitionArgument_ValueAssignment_1_1 extends AssignmentToken  {
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new DefinitionArgument_EqualsSignKeyword_1_0(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
protected class ParenthisedExpression_Group extends GroupToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new ParenthisedExpression_RightParenthesisKeyword_2(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// expr=Expression
protected class ParenthisedExpression_ExprAssignment_1 extends AssignmentToken  {
	
	public ParenthisedExpression_ExprAssignment_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getParenthisedExpressionAccess().getExprAssignment_1();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getExpressionRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getParenthisedExpressionAccess().getExprExpressionParserRuleCall_1_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new ParenthisedExpression_LeftParenthesisKeyword_0(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
// ")"
protected class ParenthisedExpression_RightParenthesisKeyword_2 extends KeywordToken  {
	
	public ParenthisedExpression_RightParenthesisKeyword_2(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getParenthisedExpressionAccess().getRightParenthesisKeyword_2();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new ParenthisedExpression_ExprAssignment_1(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
protected class ExpressionTextExpression_ExpressionAssignment_1_2 extends AssignmentToken  {
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getExpressionRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getExpressionTextExpressionAccess().getExpressionExpressionParserRuleCall_1_2_0(); 
				consumed = obj;
				return param;
			}
		}
